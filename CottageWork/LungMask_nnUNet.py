...
input_image = sitk.ReadImage('/home/claire/data/nifti/COVID_nifti/5M9RRKD5.nii.gz', imageIO='NiftiImageIO')

# print(sitk.GetArrayFromImage(input_image))
...
# def infer(data_folder=".", model_folder="/home/alex/nnunet_runs/500", prediction_folder="lung_mask_segmented_output"):
#     """
#     run inference, the output folder will be "./lung_mask_segmented_output"
#     """
